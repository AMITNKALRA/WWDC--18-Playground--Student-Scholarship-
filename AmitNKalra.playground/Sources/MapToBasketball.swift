...
public class MapToThirdActivity: UIView {
    ...
    public init(scene: UIView) { // Basically the viewDidLoad
        ...
        basketballHoop.addTarget(self, action: #selector(pressedHoop), for: .touchUpInside)
    ...
    func setupView() {
        ...
        Timer.scheduledTimer(timeInterval: 3.0, target: self, selector: #selector(loadBasketballHoop), userInfo: nil, repeats: false)
    ...
    @objc func loadFirstStep() {
        ...
        firstPath.frame = CGRect(x: 50, y: 240, width: 21, height: 9)
        firstPath.rotate(degrees: -60)
    ...
    @objc func loadSecondStep() {
        ...
        secondPath.frame = CGRect(x: 72, y: 225, width: 21, height: 9)
        secondPath.rotate(degrees: -25)
    ...
    @objc func loadThirdStep() {
        ...
        thirdPath.frame = CGRect(x: 96, y: 235, width: 21, height: 9)
        thirdPath.rotate(degrees: -132)
    ...
    @objc func loadFourthStep() {
        ...
        fourthPath.frame = CGRect(x: 110, y: 260, width: 21, height: 9)
        fourthPath.rotate(degrees: -114)
    ...
    @objc func loadFifthStep() {
        ...
        fifthPath.frame = CGRect(x: 120, y: 285, width: 21, height: 9)
        fifthPath.rotate(degrees: -114)
        self.addSubview(fifthPath)
        
    }
    
    @objc func loadBasketballHoop() {
    ...
    @objc func pressedHoop() {
        
        self.removeFromSuperview()
        
        let basketballView = BasketballView(scene: self)
        PlaygroundPage.current.liveView = basketballView
