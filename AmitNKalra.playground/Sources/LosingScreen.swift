...
public class LosingView: UIView {
    ...
    fileprivate func playFailNoise() { // Setting up the audio
        ...
        guard
            ...
            let audioURL = Bundle.main.url(forResource: "Fail", withExtension: "mp3"), // game winning noise
    ...
    func showFirstWord() {
        ...
        secondWord.text = "YOU ALREADY TOOK AN L! 😱"
        ...
        secondWord.frame = CGRect(x: 0, y: 0, width: 768, height: 400)
